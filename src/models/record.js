...
const RecordSchema = new Schema({
  ...
  elasticityAvg1st: Schema.Types.Decimal128,
  elasticityAvg2nd: Schema.Types.Decimal128,
  elasticityMax1st: Schema.Types.Decimal128,
  elasticityMax2nd: Schema.Types.Decimal128,
